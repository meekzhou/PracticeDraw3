...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float mt1 = paint1.measureText(text1);
        float mt2 = paint2.measureText(text2);

        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 + mt1, 200, paint2);
        canvas.drawText(text3, 50 + mt1 + mt2, 200, paint1);
    }
}
